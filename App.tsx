                        ...
                        {(['roundtrip', 'oneway'] as const).map((type) => (
                            <button
                                ...
                                className={`px-6 py-2 rounded-full text-sm font-bold transition-all ${
                                    searchParams.tripType === type ? 'bg-white text-blue-700 shadow-sm' : 'text-gray-500 hover:text-gray-700'
                                }`}
                            >
      ...
      <footer className="bg-gray-900 text-gray-400 py-12 border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 text-center">
            <div className="mb-6 flex justify-center">
                <span className="text-xl font-black text-white tracking-tighter">FLIGHTFARE<span className="text-blue-500">TECH</span></span>
            </div>
