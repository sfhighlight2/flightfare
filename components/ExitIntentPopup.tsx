    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md relative overflow-hidden transform transition-all scale-100">
        ...
        <div className="p-8 text-center">
          ...
          <a href="tel:+18005180250" className="block w-full bg-blue-900 text-white font-bold py-4 rounded-xl shadow-lg hover:bg-blue-800 transition-all transform hover:scale-[1.02] mb-4">
            Call (800) 518-0250 Now
          </a>
